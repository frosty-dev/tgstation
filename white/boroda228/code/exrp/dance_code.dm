/mob/living/carbon/human/proc/moan()
	...
	if (gender == FEMALE && temp_age < 30)
		playsound(get_turf(src), "white/boroda228/sounds/love/shot[rand(1, 8)].ogg", 90, 1, 0)
	else
		playsound(get_turf(src), "white/boroda228/sounds/exrp/interactions/moan_[gender == FEMALE ? "f" : "m"][rand(1, 7)].ogg", 70, 1, 0)
...
/mob/living/carbon/human/proc/end_dance(mob/living/carbon/human/partner, target_dancise)
	...
	if(gender == MALE)
		if (prob(75))
			playsound(loc, "white/boroda228/sounds/exrp/interactions/final_m[rand(1, 3)].ogg", 90, 1, 0)
		else
			playsound(loc, "white/boroda228/sounds/gachi/penetration_[rand(1, 2)].ogg", 90, 1, 0)
		...
		if(ishuman(src))
			...
			temp_age = H.age
		if (temp_age > 30)
			playsound(loc, "white/boroda228/sounds/exrp/interactions/final_f[rand(1, 5)].ogg", 70, 1, 0)
		else
			playsound(loc, "white/boroda228/sounds/love/shot9.ogg", 90, 1, 0)
...
/mob/living/carbon/human/proc/do_dance(mob/living/carbon/human/partner, action_to_do)
	...
	switch(action_to_do)
		if("do_dancero")
			...
			sound_to_play = "white/boroda228/sounds/exrp/interactions/bj[rand(1, 11)].ogg"
		...
		if ("do_facedance")
			...
			sound_to_play = "white/boroda228/sounds/exrp/interactions/oral[rand(1, 2)].ogg"
		...
		if ("do_dancor")
			...
			sound_to_play = "white/boroda228/sounds/exrp/interactions/dance[rand(1, 3)].ogg"
		...
		if ("do_dance")
			...
			sound_to_play = "white/boroda228/sounds/exrp/interactions/dance[rand(1, 2)].ogg"
		...
		if ("do_dancering")
			...
			dancing_target = null
			dancing_which = VICTIM_DANCER
			sound_to_play = "white/boroda228/sounds/exrp/interactions/champ_fingering.ogg"
			message = pick(
		...
		if ("do_handdance")
			...
			dancing_which = VICTIM_DANCER
			sound_to_play = "white/boroda228/sounds/exrp/interactions/bang[rand(1, 3)].ogg"
		...
		if ("do_mountdance")
			...
			dancing_target = null
			dancing_which = ACTOR_DANCER
			sound_to_play = "white/boroda228/sounds/exrp/interactions/squelch[rand(1, 3)].ogg"
		...
		if ("do_danceface")
			...
			dancing_target = null
			dancing_which = ACTOR_DANCER
			sound_to_play = "white/boroda228/sounds/exrp/interactions/foot_dry[rand(1, 4)].ogg"
		...
		if ("do_dancemouth")
			...
			dancing_target = null
			dancing_which = ACTOR_DANCER
			sound_to_play = "white/boroda228/sounds/exrp/interactions/foot_wet[rand(1, 3)].ogg"
			if(src.get_item_by_slot(ITEM_SLOT_FEET) != null)
				message = pick(
		...
		if ("do_eggs")
			...
			dancing_target = DANCE_TARGET_MOUTH
			dancing_which = ACTOR_DANCER
			sound_to_play = "white/boroda228/sounds/exrp/interactions/nuts[rand(1, 4)].ogg"
		...
		if ("do_thighs")
			...
			sound_to_play = "white/boroda228/sounds/exrp/interactions/[file].ogg"
