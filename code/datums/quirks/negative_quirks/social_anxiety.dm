/datum/quirk/social_anxiety
	...
	value = -3
	gain_text = span_danger("Начинаю волноваться на счёт мнения окружающих.")
...
/datum/mood_event/anxiety_eyecontact
	description = "<span class='warning'>Смотреть прямо в глаза другому человеку для меня невыносимо...</span>\n"
	mood_change = -5
	timeout = 3 MINUTES
