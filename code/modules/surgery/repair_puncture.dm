...
/datum/surgery_step/repair_innards
	name = "соедините разорванные вены (зажим)"
	implements = list(
		TOOL_HEMOSTAT = 100,
		TOOL_SCALPEL = 85,
		TOOL_WIRECUTTER = 40)
...
/datum/surgery_step/seal_veins
	name = "прижгите вены (прижигатель)" // if your doctor says they're going to weld your blood vessels back together, you're either A) on SS13, or B) in grave mortal peril
	implements = list(
		TOOL_CAUTERY = 100,
