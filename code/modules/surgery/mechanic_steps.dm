...
/datum/surgery_step/mechanic_open
	name = "раскрутите оболочку (отвертка)"
	implements = list(
...
/datum/surgery_step/mechanic_close
	name = "закрутите оболочку (отвертка)"
	implements = list(
		TOOL_SCREWDRIVER = 100,
		TOOL_SCALPEL = 75,
		/obj/item/knife = 50,
...
/datum/surgery_step/mechanic_unwrench
	name = "открутите болты (гаечный ключ)"
	implements = list(
		TOOL_WRENCH = 100,
		TOOL_RETRACTOR = 10)
	time = 24
...
/datum/surgery_step/mechanic_wrench
	name = "закрутите болты (гаечный ключ)"
	implements = list(
		TOOL_WRENCH = 100,
		TOOL_RETRACTOR = 10)
	time = 24
...
/datum/surgery_step/open_hatch
	name = "откройте заглушку (мануальное действие)"
	accept_hand = TRUE
	time = 10
	preop_sound = 'sound/items/ratchet.ogg'
